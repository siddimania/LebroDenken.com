...
<li><a href="../courses/courses.php" class="active">Courses </a></li>    
...
<div class="corners" style="width: 1670px;height: 1300px; margin-left: 50px; margin-top: 50px;background-image: url('../images/26.jpg'); "> 
...
echo '<li style="display: inline-block">
   <div class="corners" style="background-color: #F2F2F2;width: 350px;height:360px"> 
   <a href='.$url.'><img src="../images/photo/'.$shots.'" style="width: 350px;height: 200px;"/> </a>
   
       <p  style="color: #000; font-size: 20px;">'.$tags.'</p>
   <p></p>

<p class="js-popup"  ><a href="#" style="margin: 0px;font-size: 20px;color: #000;text-decoration: none;margin-top:20px">';
