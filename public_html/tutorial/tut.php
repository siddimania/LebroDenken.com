  ...
  <div class="mainhead">
    ...
    <div class="menu" align="center">
                <ul>
                  ...
                  <li><a href="../tutorial/tut.php" class="active">tutorials</a></li>
                </ul>
...
<div id="middlefield">
    ...
    <div id="contact-form" > 
<h1 align="center"> Examples of Java</h1>
</div>
    <?php
...
echo "<html>\n<head></head>\n<body>";
$sql = "SELECT * FROM CRAWL_CONTENT,CRAWLLINK where crawllink.id=crawllink.id";
$rs = mysql_query($sql);
$n = 5;

$data = "<div id =\"cent\" style=\"margin-left:100px;margin-right:100px; font-size:30px;\">" . "\n";
$i = 1;
$five=5;
while (--$five) {
    $row = mysql_fetch_array($rs);
    $data = $data . "<hr>\n" . "<br><b>Example " . $i++ . "</b>&nbsp;&nbsp;<div id=\"link\" style=\"float:right;\"><b> Courtesy : </b>".$row['link']."</div><hr><br>" . str_replace("<	d>", "", polariseCode(colorMeOut("C", strip_tags($row['content'])))) . "\n";
}
$data = $data . "<hr>\n</div>\n";
echo $data;
echo "</body>\n</html>";
