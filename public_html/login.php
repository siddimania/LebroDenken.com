                                    ...
                                    if($course=='admin'){
                                        echo "<SCRIPT LANGUAGE='JavaScript'>
                                                     $( function () {
                                                                $.magnificPopup.open({
                                                                    items: {
                                                                        src: '<div class=\"white-popup\"><div id=\"status\">Admin Panel</div><form action=\"php/adminpanel.php\" method=\"get\" style=\"margin-left:150px;\"><div class=\"info\">choice:<input style=\"margin-left:50px;\"type=\"text\" name=\"choice\"  placeholder=\"choice\"><br>Table Name:<input style=\"margin-left:10px;\" type=\"text\" name=\"tablename\"  placeholder=\"table name\"><br>column Name:<input style=\"margin-left:10px;\" type=\"text\" name=\"columnname\"  placeholder=\"column name\"><br>value:<input style=\"margin-left:60px;\" type=\"text\" name=\"value\"  placeholder=\"value\"><br>Tag:<input style=\"margin-left:70px;\" type=\"text\" name=\"tag\"  placeholder=\"tag\"> </div> <br>  <button class=\"submit clearfix\">Submit</button></form></div>',
                                                                        type: 'inline'
                                                                    }
                                                                });
                                                            });
...
echo '<li style="display: inline-block">
   ...
   <a href="http://localhost/coursePhp/phpPage.php?course=php"><img src="images/photo/'.$shots.'" style="width: 350px;height: 200px;"/> </a>
                            ...
                            <div class="updates" align="center" style="background-color: #126180; height:1080px;"> 
                                         ...
                                         <div class="corners" style="background-color: #F2F2F2;width: 350px;height:500px"> 
                                                    ...
                                                    <?php
                                                            ...
                                                            echo "<br>"; 
															echo "<marquee behavior=\"scroll\" direction=\"up\" style=\"color:#3B444B;height:430px\">";
